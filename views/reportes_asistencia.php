...
try {
    $stmt = $pdo->query("SELECT DISTINCT departamento FROM reportes_asistencias_semanales ORDER BY departamento");
    $departamentos = $stmt->fetchAll(PDO::FETCH_COLUMN);
} catch (PDOException $e) {
    die("Error al obtener departamentos: " . $e->getMessage());
}

if (isset($_POST['buscar_asistencias'])) {
...
<body>
    <div class="container">
        ...
        <!-- Contenido principal -->
        <div class="content">
            <h1><i class="fas fa-file-alt"></i> Reportes de Asistencias Semanales</h1>
            ...
            <div class="filter-section">
                <form method="POST" class="filter-form">
                    ...
                    <button type="submit" name="buscar_asistencias">
                        <i class="fas fa-search"></i> Buscar
                    </button>
                </form>
            </div>
            
            <?php if (isset($_POST['buscar_asistencias'])): ?>
                    ...
                    <table class="data-table">
                        <thead>
                            <tr>
                                ...
                                <th><i class="fas fa-user-times"></i> Total Asistencias</th>
                            </tr>
                        </thead>
                        <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-danger">
                                                <?php echo htmlspecialchars($fila['Total Asistencias']); ?>
                                            </span>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                ...
                <div class="export-buttons">
                    <a href="asistencia_semanal.php?fecha=<?php echo urlencode($fecha_seleccionada); ?>&departamento=<?php echo urlencode($departamento_seleccionado); ?>" 
                    class="btn-export">
